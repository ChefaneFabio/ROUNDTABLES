...
export const VALID_STATUS_TRANSITIONS = {
  ...
  lesson: {
    SCHEDULED: ['REMINDER_SENT', 'IN_PROGRESS', 'CANCELLED'],
  ...
  questionsStatus: {
    NOT_REQUESTED: ['QUESTIONS_REQUESTED'],
    QUESTIONS_REQUESTED: ['QUESTIONS_PENDING'],
    QUESTIONS_PENDING: ['QUESTIONS_SENT'],
    QUESTIONS_SENT: []
  },
  feedbackStatus: {
    NOT_REQUESTED: ['FEEDBACK_REQUESTED'],
    FEEDBACK_REQUESTED: ['FEEDBACK_PENDING'],
