      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md mx-auto bg-white rounded-lg shadow-md p-6">
          ...
          <p className="text-sm text-gray-500 text-center">
            You'll receive further information about the session schedule via email.
          </p>
        </div>
      </div>
    )
        ...
        <div className="grid gap-4 mb-8">
          {votingData?.topics.map((topic) => {
            ...
            return (
              <div
                key={topic.id}
                className={`bg-white rounded-lg border-2 cursor-pointer transition-all duration-200 p-6 ${
                  isSelected 
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <div className={`ml-4 rounded-full border-2 w-6 h-6 flex items-center justify-center ${
                    isSelected 
